...
| [Portao de pausa sem guarda](PENDENCIA-PORTAO-SEM-GUARDA.md) | removi os 5 nos do portao do `agente-principal.json` e as TRES guardas passaram: `n8n:sincronia` 59/0 "coerente com o gerador", `teste:pausa` "tudo certo", `n8n-validar` "nenhum problema conhecido". Todas verificam o que ESTA la; nenhuma sabe o que PRECISA estar | antes do proximo import do agente-principal |
