...
try {
  ...
  await c.query(`update public.mensagens_log set criado_em = $2 where id = $1`, [bHoje, '2026-09-21T20:00:00Z']);
  await c.query(`insert into public.uso_ingestao (tenant_id, modelo, tokens, criado_em) values ($1, 'text-embedding-3-small', 777, '2026-09-21T10:00:00Z'), ($1, 'text-embedding-3-small', 555, '2026-09-21T20:00:00Z')`, [T.a]);
