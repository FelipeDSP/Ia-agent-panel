-- Rollback da 76: NÃO EXISTE.
--
-- A 76 zera colunas de token em `mensagens_log` e `uso_ingestao` para linhas
-- anteriores a 2026-09-21T00:00Z e não guarda os valores em lugar nenhum —
